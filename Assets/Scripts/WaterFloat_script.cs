...
public class WaterFloat_script : MonoBehaviour
{
    //public properties
    ...
    {
        //get components
        Waves = FindObjectOfType<Waves_script>();
        ...
        centerOffset = PhysicsHelper_script.GetCenter(WaterLinePoints) - transform.position;
    ...
    void FixedUpdate()
    {
        ...
        //compute up vector
        TargetUp = PhysicsHelper_script.GetNormal(WaterLinePoints);
